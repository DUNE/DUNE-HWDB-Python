...
class Test__patch_hwitems_bulk(unittest.TestCase):
    ...
    def test_patch_hwitems_bulk(self):
        ...
        self.test_info["endpoint"] = f"PATCH : /component-types/Z00100300001/bulk-update"
        self.test_info["description"] = "Create two new PIDs under type ID = Z00100300001 and then patch both of them at once, while setting both Component Statuses to be QA/QC Tests Passes All"
        self.test_info["check"] = "if statuses of all processes are OK"
