...
from Sisyphus.HWDBUtility.Download import Downloader
...
def main(argv=None):
    ...
    print()
    Style.info.print("Processing download request...")
    print()


    downloader = Downloader.fromCommandLine(argv or sys.argv)
