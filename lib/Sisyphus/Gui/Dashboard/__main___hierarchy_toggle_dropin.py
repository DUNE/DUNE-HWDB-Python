...
try:
    from Sisyphus.Gui.Dashboard.callbacks.callbacks_hierarchy_chart import register_callbacks as register_fdvd_callbacks
except Exception:
    # Backward-compatible filename.
    from Sisyphus.Gui.Dashboard.callbacks.callbacks_fdvd import register_callbacks as register_fdvd_callbacks
try:
    from Sisyphus.Gui.Dashboard.utils.config import ENABLE_HIERARCHY_CHART_TAB as ENABLE_FDVD_TAB
except Exception:
    from Sisyphus.Gui.Dashboard.utils.config import ENABLE_FDVD_TAB
