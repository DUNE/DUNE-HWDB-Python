...
# Pretty much used as-is by Alex Wagner, with only minor changes
...
class TreeItem:
    ...
    @classmethod
    def load(
        cls, value: list | dict, parent: "TreeItem" = None, sort=False
    ) -> "TreeItem":
...
def main():
    ...
    filename = sys.argv[1]
    json_path = QFileInfo(__file__).absoluteDir().filePath(filename)
